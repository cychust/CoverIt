...
class TitleBar : ViewGroup, View.OnClickListener {
    ...
    private fun initView(context: Context) {
        ...
        mCenterText.setTextColor(ContextCompat.getColor(context,R.color.title_white))
        mCenterText.text = "记背列表"
     ...
     */
    private fun addAction(action: Action): View {
     ...
     */
    private fun addAction(action: Action, index: Int): View {
